...
export function Fieldguide({ id: runId }: AgentProps) {
	...
	const record = [
		...
		'  staff-recollection, never fact. An inference may describe a step or a',
		'  friction, but it can never be the support under a recommendation, the',
		'  evidence behind a value, or one side of a contradiction.',
